...
###############################################################################
# Define ez::support::private_compile_options - a target representing a set of
...
add_library(ez_support_private_compile_options INTERFACE)
add_library(ez::support::private_compile_options ALIAS ez_support_private_compile_options)

# Use ez::common::compile_options (from ez-common) as a basis for a set of private compile options
# for this project.
target_link_libraries(ez_support_private_compile_options
    INTERFACE
    ez::common::compile_options
)

###############################################################################
# Define ez::support::public_compile_options - a target representing a set of
...
#
# This set forms a compliment to ez::support::private_compile_options (see
# above).
###############################################################################

add_library(ez_support_public_compile_options INTERFACE)
add_library(ez::support::public_compile_options ALIAS ez_support_public_compile_options)

# Make a requirement on minimal version of C++ Standard for this project be exportable.
target_compile_features(ez_support_public_compile_options
    INTERFACE
    cxx_std_${EZ_SUPPORT_CPP_MINIMUM_REQUIRED}
)

# Export the project public compile options.
install(TARGETS ez_support_public_compile_options EXPORT ez-libs)
set_target_properties(ez_support_public_compile_options
    PROPERTIES
    EXPORT_NAME support_public_compile_options
)
